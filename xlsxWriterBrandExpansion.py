...
range1 = [0,1,2,4,7,8,12,13,22,23,30]

# Range for all custom attribute columns
range2 = range(37,length)
...
no_match_df = no_match_df.drop(columns = ['active', 'Match Type', 'Match Result', 'Best SID', 'Account', 'Country Code', 'Country Name'])
