...
### READ CSV 
f = 'ServiceNow (Top 50, UK, NL)_2018-11-05_135935_output.csv'
...
range1 = [0,1,2,3,4,7,8,9,10,14,17,19,20,21,28]
...
cols = ['active', 'Match Result', 'Country Name', 'Source State', 'State']
...
# Excel filename
f2 = 'ServiceNow (Top 50, UK, NL)_2018-11-05_135935_output.xlsx'
